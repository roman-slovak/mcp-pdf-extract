...
class TestResolvePdfPath:
    ...
    def test_bare_filename_error_nudges_to_absolute(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        # Server's own CWD almost never matches the model's CWD; the error should
        # tell the model to pass an absolute path next time.
